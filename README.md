...
Composer Package Manager, NodeJS, NPM, Gulp
...
- Untuk menghasilkan key->
  php artisan key:generate

- Untuk membuat tabel-tabel dan seeding datanya->
  php artisan migrate:refresh --seed
  
- Untuk membuild plugin tambahan->
  gulp
  
- Jalankan built in server bawaan laravel dengan perintah->
  php artisan serve

for contact information: www.fauzanlubis.com
